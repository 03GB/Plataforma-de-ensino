...
<!-- js -->
    ...
    <div class="collapse navbar-collapse " id="navbarTogglerDemo02" style="background-color:#285e61;margin-top:20px; padding-left: 20px;">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0" >
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="pag01.php">Página Inicial</a>
        </li>
        <li class="nav-item">
          <a class="nav-link  active" href="maestro.php">Maestro</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
        <a href="logout.php"  class="nav-link  active" >Fazer Logout</a>
        </li>
